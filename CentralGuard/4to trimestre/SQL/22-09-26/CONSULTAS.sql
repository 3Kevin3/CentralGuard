...
-- 11. Comprobar que las contraseñas no se guardan en texto plano (se ven solo hash y salt)
select usuario, `contraseña` as hash_sha256, salt from usuarios limit 5;

-- 12. Probar el login con la función (1 = correcto, 0 = incorrecto)
select fn_validar_login('admin1', 'admin1754') as login_correcto,
       fn_validar_login('admin1', 'clave_mala') as login_incorrecto;